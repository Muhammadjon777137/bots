...
@dp.message_handler(Text(equals="The phone will find the Username of the user from the number"))
async def start_bot(messege: types.Message):
    await messege.answer("Men username jonataman nomer tashlang", reply_markup=back())
